...
| [0009](0009-standard-expresses-one-actor-approval-needs-two.md) | The standard expresses one actor; a defensible approval needs two — v4 models agent + issuer but has no approver principal and one signature slot (the issuer's, not the decider's); found scoping B3's AML disposition record, confirmed same-day in TrueForge and v4; general (AMLR Art. 18 / AI Act Art. 14), belongs upstream per ADR-0008 | proposed 2026-09-06, **corrected same day** (gap 3 restated: a person-capable GNS layer exists — the gap is no *accountable, verified* person identity wired to the signature model; `human`-by-absence must become positive+verified; shared framing with 0008) |
