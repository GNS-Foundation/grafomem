...
Runs the GMP v0.2 conformance suite against the QdrantGMPBackend
...
def _make_factory():
    """Factory that creates fresh QdrantGMPBackend instances.
    ...
    # QdrantGMPBackend calls embed_fn with a SINGLE string, so we
...
def main():
    ...
    print(f"  Backend:  QdrantGMPBackend")
    ...
    if profile.violations:
        ...
        print()
        print("  The QdrantGMPBackend does NOT pass its own conformance suite.")
        ...
        print()
        print("  The QdrantGMPBackend SUPPORTS everything it declares:")
