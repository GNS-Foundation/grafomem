...
Runs all five two-sided self-conformance suites (R1-R5) against the database in
GRAFOMEM_DB_URL. Discoverable by pytest as five parametrized cases; also runnable directly.
